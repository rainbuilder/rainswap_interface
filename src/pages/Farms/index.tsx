  ...
  return (
    <>
      <Container>
        ...
        <div style={{ color: '#fa4c4c', textAlign: 'center' }}>This project is in beta.</div>
        <Spacer size="lg" />
        <div
          style={{
      ...
      <Box className="mt-4">
        ...
        <StyledParagraph>Earn RAIN tokens by staking RAIN-BUSD CAKE-LP token</StyledParagraph>
        {/* <SpacerRes>
                <Spacer size="sm" />
            </SpacerRes>
            <StyledInfo>
