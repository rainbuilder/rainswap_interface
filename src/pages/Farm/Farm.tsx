...
import { getContract } from '../../sushi/format/bep20'
    ...
    <>
      <PageHeader
        icon={
          <div style={{ display: 'flex' }}>
            <img src={icon} height="80" alt="header" />
            &nbsp;
            <img src={icon2} height="80" alt="header" />
          </div>
        }
      ...
      <StyledFarm>
        ...
        <span role="img" aria-label="Information">
          {' '}
          <StyledInfo style={{ color: '#348afa' }}>
            👉 Every time you stake and unstake LP tokens, the contract will
            <br />
            automatically harvest RAIN rewards for you!
          </StyledInfo>
        </span>
        <Spacer size="lg" />
        <StyledCardsWrapper>
          <div>
            ...
            <StyledInfoLP>
              ...
              >
                <div>
                  Add liquidity to{' '}
                  <a style={{ color: '#348afa', textDecoration: 'none' }} href={pairLink} target="__blank">
                    <b>{symbolShort} pair</b>
                  </a>{' '}
                  on {protocal} to get <span style={{ color: '#348afa' }}>{lpToken}</span> tokens. Then deposit those LP
                  tokens on Rain Floodgate to receive rewards
                </div>
                <Spacer size="sm" />
                <a style={{ color: '#348afa' }} target="__blank" href={addLiquidityLink}>
