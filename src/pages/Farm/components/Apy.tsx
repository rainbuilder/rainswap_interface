...
function formatApy(apyValue: any) {
  ...
  return (
    <StyledApy>
      ...
      <StyledBox className="col-7">
        ...
        <StyledContent>
          {stakedValue && stakedValue.tokenAmount ? stakedValue.tokenAmount.toFixed(4).toLocaleString() : '~'}{' '}
          <span style={{ fontSize: 10 }}>{tokenSymbol}</span>
          &nbsp; + &nbsp;
          {stakedValue && stakedValue.token2Amount ? stakedValue.token2Amount.toFixed(4).toLocaleString() : '~'}{' '}
      ...
      <StyledBox className="col-2">
        ...
        <StyledContent>{newReward ? getBalanceNumber(newReward).toFixed(2) : '~'} RAIN</StyledContent>
        <StyledEquility>
          ≈{' '}
          {stakedValue &&
            newReward &&
