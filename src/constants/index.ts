import { ChainId, JSBI, Percent, Token, WETH as UETH } from '@luaswap/sdk'
import { ChainId as PChainId, Token as PToken, WETH as PETH } from '@pancakeswap-libs/sdk'
import { AbstractConnector } from '@web3-react/abstract-connector'

import { injected, walletconnect } from '../connectors' // remove portis, fortmatic
...
const WETH = { ...UETH, ...PETH }

// a list of tokens by chain
type ChainTokenList = {
  readonly [chainId in ChainId | PChainId]: Array<any>
}
...
export const CAKE: { [chainId in PChainId]: PToken } = {
  56: new PToken(PChainId.MAINNET, CAKE_ADDRESS, 18, 'CAKE', 'PancakeSwap'),
  97: new PToken(PChainId.BSCTESTNET, CAKE_ADDRESS, 18, 'CAKE', 'PancakeSwap')
}
...
const WETH_ONLY: ChainTokenList = {
  ...
  [PChainId.MAINNET]: [PETH[56]],
  [PChainId.BSCTESTNET]: [PETH[97]],
...
export const BASES_TO_CHECK_TRADES_AGAINST: ChainTokenList = {
  ...
  [PChainId.MAINNET]: [...WETH_ONLY[PChainId.MAINNET], BUSD, WBNB],
